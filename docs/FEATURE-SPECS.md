...
**Output:** Dropdown shows current selection. Log: "DNS set to hns: 198.51.100.1, 198.51.100.1"
**Presets:** `default: [208.67.222.222]`, `hns: [198.51.100.1]`, `cloudflare: [1.1.1.1]`, `google: [8.8.8.8]`
